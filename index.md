...
ADMET HACKATON (Иннополис, сентябрь), 3 место в индивидуальном зачете. Моя роль – дата сайентист в разработке точных моделей классификации, способных предсказывать бинарные метки на основе химических структур соединений, представленных в формате SMILES.
